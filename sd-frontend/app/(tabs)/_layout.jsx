      ...
      <Tabs screenOptions={{
        ...
        <Tabs.Screen 
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({color, focused}) => (
              <TabIcon color={color} icon={'beaker-outline'} iconFilled={'beaker'} title="Bins" focused={focused} />
            )
          }} 
        />
        ...
        <Tabs.Screen 
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({color, focused}) => (
              <TabIcon color={color} icon={'cash-outline'} iconFilled={'cash'} title="Pay" focused={focused} />
            )
          }} 
        />       
