...
export default function AdminPanel() {
  ...
  return (
    <div className="adminPanelImg">
      ...
      {/* Header */}
      <div className="row me-5 ps-5 pe-5" style={{
        position: 'relative',
        backgroundColor: '#1DB954',
        width: '100%',
        height: '70px',
      ...
      <div className="d-flex flex-wrap justify-content-between ps-5 pe-5 ms-5 me-5 pt-5">
        <Link to={'inquiry/report'} style={{ textDecoration: 'none' }}>
          <div className="card div-shadow" style={cardStyle} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
            <h1 style={{ fontSize: '56px' }}>Inquiry</h1>
          </div>
        </Link>

        <Link to={'bin/dashboard'} style={{ textDecoration: 'none' }}>
          <div className="card div-shadow" style={cardStyle} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
